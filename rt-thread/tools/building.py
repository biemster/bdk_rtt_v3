...
def PrepareBuilding(env, root_directory, has_libcpu=False, remove_components = []):
    ...
    if GetOption('buildlibs'):
        if GetOption('beken') == 'bk7231n':
            ...
            DoSystemCall("scons --beken=bk7231n --buildlib=beken_cal -j8")
            DoSystemCall("scons --beken=bk7231n --buildlib=beken_rf_test -j8")
            DoSystemCall("scons --beken=bk7231n --buildlib=beken_rf_use -j8")
            DoSystemCall("scons --beken=bk7231n --buildlib=beken_uart_debug -j8")
            DoSystemCall("scons --beken=bk7231n --buildlib=beken_supplicant -j8")
            ...
            DoSystemCall("scons --beken=bk7231u --buildlib=beken_cal -j8")
            DoSystemCall("scons --beken=bk7231u --buildlib=beken_rf_test -j8")
            DoSystemCall("scons --beken=bk7231u --buildlib=beken_rf_use -j8")
            DoSystemCall("scons --beken=bk7231u --buildlib=beken_uart_debug -j8")
            DoSystemCall("scons --beken=bk7231u --buildlib=beken_supplicant -j8")
            ...
            DoSystemCall("scons --beken=bk7236 --buildlib=beken_cal -j8")
            DoSystemCall("scons --beken=bk7236 --buildlib=beken_rf_test -j8")
            DoSystemCall("scons --beken=bk7236 --buildlib=beken_rf_use -j8")
            DoSystemCall("scons --beken=bk7236 --buildlib=beken_uart_debug -j8")
            DoSystemCall("scons --beken=bk7236 --buildlib=beken_supplicant -j8")
            ...
            DoSystemCall("scons --beken=bk7271 --buildlib=beken_cal -j8")
            DoSystemCall("scons --beken=bk7271 --buildlib=beken_rf_test -j8")
            DoSystemCall("scons --beken=bk7271 --buildlib=beken_rf_use -j8")
            DoSystemCall("scons --beken=bk7271 --buildlib=beken_uart_debug -j8")
            DoSystemCall("scons --beken=bk7271 --buildlib=beken_supplicant -j8")
            ...
            DoSystemCall("scons --beken=bk7251 --buildlib=beken_cal -j8")
            DoSystemCall("scons --beken=bk7251 --buildlib=beken_rf_test -j8")
            DoSystemCall("scons --beken=bk7251 --buildlib=beken_rf_use -j8")
            DoSystemCall("scons --beken=bk7251 --buildlib=beken_uart_debug -j8")
            DoSystemCall("scons --beken=bk7251 --buildlib=beken_supplicant -j8")
    ...
    if GetOption('cleanlibs'):
        if GetOption('beken') == 'bk7231n':
            ...
            DoSystemCall("scons --beken=bk7231n --cleanlib=beken_cal -j8")
            DoSystemCall("scons --beken=bk7231n --cleanlib=beken_rf_test -j8")
            DoSystemCall("scons --beken=bk7231n --cleanlib=beken_rf_use -j8")
            DoSystemCall("scons --beken=bk7231n --cleanlib=beken_uart_debug -j8")
            DoSystemCall("scons --beken=bk7231n --cleanlib=beken_supplicant -j8")
        elif GetOption('beken') == 'bk7231u':
            ...
            DoSystemCall("scons --beken=bk7231u --cleanlib=beken_cal -j8")
            DoSystemCall("scons --beken=bk7231u --cleanlib=beken_rf_test -j8")
            DoSystemCall("scons --beken=bk7231u --cleanlib=beken_rf_use -j8")
            DoSystemCall("scons --beken=bk7231u --cleanlib=beken_uart_debug -j8")
            DoSystemCall("scons --beken=bk7231u --cleanlib=beken_supplicant -j8")
        elif GetOption('beken') == 'bk7236':
            ...
            DoSystemCall("scons --beken=bk7236 --cleanlib=beken_cal -j8")
            DoSystemCall("scons --beken=bk7236 --cleanlib=beken_rf_test -j8")
            DoSystemCall("scons --beken=bk7236 --cleanlib=beken_rf_use -j8")
            DoSystemCall("scons --beken=bk7236 --cleanlib=beken_uart_debug -j8")
            DoSystemCall("scons --beken=bk7236 --cleanlib=beken_supplicant -j8")
        elif GetOption('beken') == 'bk7271':
            ...
            DoSystemCall("scons --beken=bk7271 --cleanlib=beken_cal -j8")
            DoSystemCall("scons --beken=bk7271 --cleanlib=beken_rf_test -j8")
            DoSystemCall("scons --beken=bk7271 --cleanlib=beken_rf_use -j8")
            DoSystemCall("scons --beken=bk7271 --cleanlib=beken_uart_debug -j8")
            DoSystemCall("scons --beken=bk7271 --cleanlib=beken_supplicant -j8")
            ...
            DoSystemCall("scons --beken=bk7251 --cleanlib=beken_cal -j8")
            DoSystemCall("scons --beken=bk7251 --cleanlib=beken_rf_test -j8")
            DoSystemCall("scons --beken=bk7251 --cleanlib=beken_rf_use -j8")
            DoSystemCall("scons --beken=bk7251 --cleanlib=beken_uart_debug -j8")
            DoSystemCall("scons --beken=bk7251 --cleanlib=beken_supplicant -j8")
    ...
    if tgt_name:
        ...
        try:
            ...
            print('Unknow target: %s. Avaible targets: %s' % (tgt_name, ', '.join(tgt_dict.keys())))
            sys.exit(1)
...
def GetDepend(depend):
    ...
    if type(depend) == type('str'):
        if not BuildOptions.get(depend) or BuildOptions[depend] == 0:
            building = False
    ...
    for item in depend:
        if item != '':
            if not BuildOptions.get(item) or BuildOptions[item] == 0:
                building = False
...
def GetLocalDepend(options, depend):
    building = True
    if type(depend) == type('str'):
        if not options.get(depend) or options[depend] == 0:
            building = False
        elif options[depend] != '':
    ...
    for item in depend:
        if item != '':
            if not options.get(item) or options[item] == 0:
                building = False
...
def DefineGroup(name, src, depend, **parameters):
    ...
    if not GetOption('buildlib') and os.path.exists(os.path.join(group['path'], GroupLibFullName(name, Env))):
        group['src'] = []
        if group.get('LIBS'): group['LIBS'] = group['LIBS'] + [GroupLibName(name, Env)]
        else : group['LIBS'] = [GroupLibName(name, Env)]
        if group.get('LIBPATH'): group['LIBPATH'] = group['LIBPATH'] + [GetCurrentDir()]
...
def DoBuilding(env, target, objects):
    ...
    def local_group(group, objects):
        if group.get('LOCAL_CCFLAGS') or group.get('LOCAL_CPPPATH') or group.get('LOCAL_CPPDEFINES') or group.get('LOCAL_ASFLAGS'):
    ...
    if GetOption('buildlib'):
        ...
        for group in Projects:
            if group.get('LOCAL_CCFLAGS') or group.get('LOCAL_CPPPATH') or group.get('LOCAL_CPPDEFINES'):
                for source in group['src']:
                    for obj in objects:
